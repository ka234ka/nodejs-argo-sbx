...
const UUID = process.env.UUID || '21dca8b6-0db4-4edc-a4fa-c98f28d19520'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
...
function getFilesForArchitecture(architecture) {
  ...
  if (architecture === 'arm') {
    baseFiles = [
      { fileName: webPath, fileUrl: "https://github.com/ka234ka/go-sbx/releases/download/argosbx/xray-arm64" },
      { fileName: botPath, fileUrl: "https://github.com/cloudflare/cloudflared/releases/latest/download/cloudflared-linux-arm64" }
    ];
  } else {
    baseFiles = [
      { fileName: webPath, fileUrl: "https://github.com/ka234ka/go-sbx/releases/download/argosbx/xray-amd64" },
